package com.bellogatecaliphate.create_post.ui.delete_post
...
@Composable
internal fun DeletePostConfirmationDialog(
	isVisible: Boolean,
	...
	ModalBottomSheet(
		...
		Column(
			...
			Text(stringResource(id = R.string.delete_post_confirmation_message))
